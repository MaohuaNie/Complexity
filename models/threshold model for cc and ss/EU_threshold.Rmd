...
parameters = c("transf_mu_alpha","transf_mu_threshold","transf_mu_ndt", "transf_mu_theta","transf_mu_delta_threshold", 'sd_threshold',"sd_alpha","sd_ndt", 'sd_theta', 'sd_delta_threshold', "alpha_sbj","threshold_sbj","ndt_sbj",'theta_sbj','delta_threshold_sbj', "log_lik")
...
initFunc <-function (i) {
  ...
  for (ll in 1:i){
    initList[[ll]] = list(mu_alpha = runif(1,-1.4578,2.5413), 
                          ...
                          mu_delta_threshold = runif(1, -0.25, 0.25), 
                          sd_delta_threshold = runif(1,0,1),
                          ...
                          z_delta_threshold = runif(length(tids),-0.1,0.1)
...
```{r message=FALSE, warning=FALSE}
m <- stan_model("EU_threshold.stan")
dsamples <- sampling(m,  
                data=dataList, 
                pars=parameters,
                iter=2000, 
...
```{r message=FALSE, warning=FALSE}
#"transf_mu_alpha","transf_mu_threshold","transf_mu_ndt", "transf_mu_theta","transf_mu_delta_threshold", 'sd_threshold',"sd_alpha","sd_ndt", 'sd_theta', 'sd_delta_threshold', "alpha_sbj","threshold_sbj","ndt_sbj",'theta_sbj','delta_threshold_sbj', "log_lik"

rstan::traceplot(dsamples, pars=c("transf_mu_alpha","transf_mu_threshold","transf_mu_ndt", "transf_mu_theta","transf_mu_delta_threshold", 'sd_threshold',"sd_alpha","sd_ndt", 'sd_theta', 'sd_delta_threshold', "lp__"), inc_warmup = TRUE, nrow = 3)

pairs(dsamples, pars = c("transf_mu_alpha","transf_mu_threshold","transf_mu_ndt", "transf_mu_theta","transf_mu_delta_threshold", 'sd_threshold',"sd_alpha","sd_ndt", 'sd_theta', 'sd_delta_threshold', "lp__"))
print(dsamples, pars = c("transf_mu_alpha","transf_mu_threshold","transf_mu_ndt", "transf_mu_theta","transf_mu_delta_threshold", 'sd_threshold',"sd_alpha","sd_ndt", 'sd_theta', 'sd_delta_threshold', "lp__"))
```
...
parameters <- c("transf_mu_alpha","transf_mu_threshold","transf_mu_ndt", "transf_mu_theta","transf_mu_delta_threshold")
