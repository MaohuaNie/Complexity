...
```{r message=FALSE, warning=FALSE}
dat$trialtype1 <- ifelse(dat$skew == "ns", -1, ifelse(dat$skew == "lr", 1, ifelse(dat$skew == "rl", 0, NA)))
dat$trialtype2 <- ifelse(dat$skew == "ns", -1, ifelse(dat$skew == "lr", 0, ifelse(dat$skew == "rl", 1, NA)))
...
dataList  = list(cho = dat$cho, rt = dat$rt, participant = dat$tid,N=nrow(dat),  L = length(tids),starting_point=0.5, evd = dat$evd, sdd = dat$sdd, trialtype1 = dat$trialtype1, trialtype2 = dat$trialtype2)
...
```{r}
parameters = c("transf_mu_alpha","transf_mu_threshold","transf_mu_ndt", "transf_mu_theta",'transf_mu_delta_con1','transf_mu_delta_con2', 'sd_threshold',"sd_alpha","sd_ndt", 'sd_theta', 'sd_delta_con1', 'sd_delta_con2', "alpha_sbj","threshold_sbj","ndt_sbj",'theta_sbj', 'delta_con1_sbj','delta_con2_sbj', "log_lik")
...
initFunc <-function (i) {
  ...
  for (ll in 1:i){
    initList[[ll]] = list(
                          ...
                          mu_delta_con1 = runif(1,-1, 1), 
                          sd_delta_con1 = runif(1, 0, 1),
                          mu_delta_con2 = runif(1,-1, 1), 
                          sd_delta_con2 = runif(1, 0, 1),
                          ...
                          z_delta_con1 = runif(length(tids),-0.1,0.1),
                          z_delta_con2 = runif(length(tids),-0.1,0.1)
...
rstan::traceplot(dsamples, pars=c("transf_mu_alpha","transf_mu_threshold","transf_mu_ndt", "transf_mu_theta",'transf_mu_delta_con1','transf_mu_delta_con2', 'sd_threshold',"sd_alpha","sd_ndt", 'sd_theta', 'sd_delta_con1','sd_delta_con2', "lp__"), inc_warmup = TRUE, nrow = 3)

pairs(dsamples, pars = c( "transf_mu_alpha","transf_mu_threshold","transf_mu_ndt", "transf_mu_theta",'transf_mu_delta_con1','transf_mu_delta_con2', 'sd_threshold',"sd_alpha","sd_ndt", 'sd_theta', 'sd_delta_con1','sd_delta_con2', "lp__"))
print(dsamples, pars = c("transf_mu_alpha","transf_mu_threshold","transf_mu_ndt", "transf_mu_theta",'transf_mu_delta_con1','transf_mu_delta_con2', 'sd_threshold',"sd_alpha","sd_ndt", 'sd_theta', 'sd_delta_con1','sd_delta_con2',"lp__"))
...
parameters <- c("transf_mu_alpha","transf_mu_threshold","transf_mu_ndt", "transf_mu_theta",'transf_mu_delta_con1', 'transf_mu_delta_con2')
