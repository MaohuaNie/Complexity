...
transformed parameters {
	...
	for (n in 1:N) {
		uc[n] = pweight(pc[n,1], (gamma_sbj[participant[n]] + delta_sbj[participant[n]])) * pow(oc[n,1],alpha_sbj[participant[n]]) + (1- pweight(pc[n,1], (gamma_sbj[participant[n]] + delta_sbj[participant[n]]))) * pow(oc[n,2],alpha_sbj[participant[n]]);
		us[n] = pweight(ps[n,1], (gamma_sbj[participant[n]] - delta_sbj[participant[n]])) * pow(os[n,1],alpha_sbj[participant[n]]) + (1- pweight(ps[n,1], (gamma_sbj[participant[n]] - delta_sbj[participant[n]]))) * pow(os[n,2],alpha_sbj[participant[n]]);
