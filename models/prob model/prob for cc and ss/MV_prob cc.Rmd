...
dataList  = list(cho = dat$cho, rt = dat$rt, participant = dat$tid,N=nrow(dat),  L = length(tids),starting_point=0.5, evd = dat$evd, sdd = dat$sdd, trialtype1 = dat$trialtype1, trialtype2 = dat$trialtype2, con = dat$con)
...
```{r}
parameters = c("transf_mu_alpha","transf_mu_threshold","transf_mu_ndt", "transf_mu_theta",'transf_mu_delta1','transf_mu_delta2', 'transf_mu_zeta1','transf_mu_zeta2', 'sd_threshold',"sd_alpha","sd_ndt", 'sd_theta', 'sd_delta1','sd_delta2', 'sd_zeta1','sd_zeta2', "alpha_sbj","threshold_sbj","ndt_sbj",'theta_sbj', 'delta1_sbj','delta2_sbj','zeta1_sbj', 'zeta2_sbj',"log_lik")
...
initFunc <-function (i) {
  ...
  for (ll in 1:i){
    initList[[ll]] = list(
                          ...
                          mu_delta1 = runif(1,-1, 1), 
                          sd_delta1 = runif(1, 0, 1),
                          mu_delta2 = runif(1,-1, 1), 
                          sd_delta2 = runif(1, 0, 1),
                          mu_zeta1 = runif(1,-1, 1), 
                          sd_zeta1 = runif(1, 0, 1),
                          mu_zeta2 = runif(1,-1, 1), 
                          sd_zeta2 = runif(1, 0, 1),
                          ...
                          z_delta1 = runif(length(tids),-0.1,0.1),
                          z_delta2 = runif(length(tids),-0.1,0.1),
                          z_zeta1 = runif(length(tids),-0.1,0.1),
                          z_zeta2 = runif(length(tids),-0.1,0.1)
...
parameters <- c("transf_mu_alpha","transf_mu_threshold","transf_mu_ndt", "transf_mu_theta",'transf_mu_delta1', 'transf_mu_delta2', 'transf_mu_zeta1', 'transf_mu_zeta2')
