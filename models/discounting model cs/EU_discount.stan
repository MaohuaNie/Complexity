...
transformed parameters {
	...
	for (n in 1:N) {
		uc[n] = pc[n,1] * pow(oc[n,1],alpha_sbj[participant[n]]) + pc[n,2] * pow(oc[n,2],alpha_sbj[participant[n]]) + beta_sbj[participant[n]];
		us[n] = ps[n,1] * pow(os[n,1],alpha_sbj[participant[n]]) + ps[n,2] * pow(os[n,2],alpha_sbj[participant[n]]) - beta_sbj[participant[n]];
