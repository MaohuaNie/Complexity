...
model {
	...
	print("target = ", target(), " when mu_alpha = ", mu_alpha);
	print("target = ", target(), " when mu_theta = ", mu_theta);
	print("target = ", target(), " when mu_threshold = ", mu_threshold);
	print("target = ", target(), " when mu_ndt = ", mu_ndt);
