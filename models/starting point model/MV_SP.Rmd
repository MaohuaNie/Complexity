...
dataList  = list(cho = rcontrol_dat$chose_complex, accuracy_flipped = rcontrol_dat$cho2, rt = rcontrol_dat$rt, participant = rcontrol_dat$tid,N=nrow(rcontrol_dat),  L = length(tids), evd = rcontrol_dat$evd, sdd = rcontrol_dat$sdd)
